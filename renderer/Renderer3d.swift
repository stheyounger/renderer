...
struct Renderer3d {
    ...
    func render(camera: Camera, objects: [Surface3d]) -> [Surface2d] {
        return objects.map { object in
            ...
            let projection: [Line<Point2d>?] = wireframe.map { line in
...
//                    }
            ...
            let nullRemovedProjectedLines = projection.filter { line in line != nil }.map { line in line! }
            
            return Surface2d(lines: nullRemovedProjectedLines, color: object.color)
        }
    }
}
